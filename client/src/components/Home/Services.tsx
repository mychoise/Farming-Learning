...
const Services = () => {
    return (
        <div className="pl-10 pb-10  flex justify-between pt-10 bg-[#F4F4F4] ">
            <div className="w-[37%]">
                <h1 className="font-[font10] text-2xl  ">
                    OUR SERVICES
                </h1>
            ...
            <div>
                <div>
<div className="w-[63%]  flex flex-row gap-7">
    ...
    <img src="https://static.wixstatic.com/media/c837a6_dd4a0f7d40534faca1a836f94f2c143e~mv2.jpeg/v1/fill/w_371,h_548,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/AdobeStock_531607815.jpeg"/>
                ...
                <button className="bg-[#F3FFB2] mt-6 font-[font10] cursor-pointer text-[18px] hover:underline px-8 border rounded-4xl py-1.5">ALL SERVICES</button>
