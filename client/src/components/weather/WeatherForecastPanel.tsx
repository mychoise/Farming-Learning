...
const weatherData: WeatherItem[] = [
  { day: "Mon", high: 26, low: 18, condition: "Sunny Day", icon: "☀️", rain: 5, rainfall: 0, wind: 12, tag: "GOOD SOWING", tagColor: "text-emerald-500", tagBg: "bg-emerald-50", gradient: "from-amber-100 to-orange-50", iconBg: "bg-amber-100" },
